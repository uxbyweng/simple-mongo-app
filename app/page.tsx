...
export default function Home() {
  ...
  const countLabel =
    entries.length === 1 ? "1 Mitteilung" : `${entries.length} Mitteilungen`;
  ...
  return (
    <div
      style={{
        ...
        background: "linear-gradient(155deg,#6b4d31,#4a3420 45%,#5d4229)",
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: 8,
          padding: 14,
          background: "linear-gradient(180deg,#8a6640,#5b3f26 55%,#7a5735)",
          boxShadow: "0 30px 60px rgba(0,0,0,.45),inset 0 1px 0 rgba(255,255,255,.18)",
        }}
      >
        {/* Chalkboard surface */}
        <div
          style={{
            ...
            borderRadius: 4,
            background:
              "radial-gradient(120% 90% at 22% 12%,#3b4a43 0%,#2c3833 45%,#232d29 100%)",
            boxShadow:
              "inset 0 0 90px rgba(0,0,0,.65),inset 0 2px 0 rgba(255,255,255,.06)",
        ...
        >
            ...
            <div>
              <h1
                style={{
                  ...
                  color: "#f3f0e6",
                  textShadow:
                    "0 0 14px rgba(243,240,230,.18),0 2px 0 rgba(0,0,0,.25)",
                  letterSpacing: ".5px",
                }}
              >
                Schwarzes Brett
              ...
              <svg
                ...
                height="14"
                viewBox="0 0 330 14"
                style={{ display: "block", marginTop: 6, opacity: 0.55 }}
              >
                <path
                  d="M2 7 C 70 2, 150 11, 240 5 S 310 9, 328 6"
                  fill="none"
                  stroke="#f3f0e6"
                  strokeWidth="3"
                  strokeLinecap="round"
                    ...
                    {CHALKS.map((c, i) => (
                      <button
                        ...
                        style={{
                          ...
                          border:
                            i === chalk
                              ? "2px solid rgba(243,240,230,.9)"
                              : "2px solid rgba(0,0,0,.2)",
                          boxShadow:
                            i === chalk ? `0 0 14px ${c.hex}80` : "none",
                          padding: 0,
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    animation: gone
                      ? "dustOut .4s ease forwards"
                      : "chalkIn .5s ease both",
                  }}
                >
                  <div
                    style={{
          ...
          <div
            style={{
              position: "relative",
              margin: "46px -48px -40px",
              padding: "16px 48px",
              display: "flex",
              alignItems: "center",
              gap: 12,
              background: "linear-gradient(180deg,#7a5735,#4f371f)",
              boxShadow:
                "0 -8px 24px rgba(0,0,0,.35),inset 0 1px 0 rgba(255,255,255,.16)",
            }}
          >
            <div style={{ width: 52, height: 11, borderRadius: 3, background: "#f3f0e6", boxShadow: "0 1px 2px rgba(0,0,0,.4)" }} />
            <div style={{ width: 38, height: 11, borderRadius: 3, background: "#f6e7a8", boxShadow: "0 1px 2px rgba(0,0,0,.4)" }} />
            <div style={{ width: 44, height: 11, borderRadius: 3, background: "#bcd9e8", boxShadow: "0 1px 2px rgba(0,0,0,.4)" }} />
            <div
              style={{
                marginLeft: "auto",
                width: 74,
                height: 26,
                borderRadius: 4,
                background: "linear-gradient(180deg,#5c6b63,#3f4a45)",
                boxShadow:
                  "0 2px 4px rgba(0,0,0,.45),inset 0 1px 0 rgba(255,255,255,.12)",
              }}
            />
          </div>
        </div>
